    ...
    <div className="membersPage">
      <section className="membersPage__hero">
        <div className="membersPage__heroInner">
          <h1 className="membersPage__heroTitle">Our Community</h1>
          <p className="membersPage__heroSubtitle">
            ...
            {stats.map((stat, index) => (
              ...
              <div key={index} className="membersPage__stat">
                <div className="membersPage__statIcon" aria-hidden="true">
                  <stat.icon className="membersPage__statSvg" />
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="membersPage__form">
                    <div className="membersPage__grid2Inner">
                      <div className="membersPage__field">
                        ...
                        <input type="text" name="name" value={formData.name} onChange={handleInputChange} required className="membersPage__input" placeholder="Enter your full name" />
                      </div>
                      <div className="membersPage__field">
                        <label className="membersPage__label">Father Name *</label>
                        <input type="text" name="father_name" value={formData.father_name} onChange={handleInputChange} required className="membersPage__input" placeholder="Enter father name" />
                      </div>
                    </div>
                    ...
                    <div className="membersPage__grid2Inner">
                      <div className="membersPage__field">
                        ...
                        <input type="text" name="designation" value={formData.designation} onChange={handleInputChange} required className="membersPage__input" placeholder="Your profession/designation" />
                      </div>
                      <div className="membersPage__field">
                        <label className="membersPage__label">CNIC *</label>
                        <input type="text" name="cnic" value={formData.cnic} onChange={handleInputChange} required className="membersPage__input" placeholder="00000-0000000-0" />
                      </div>
                    </div>
                    ...
                    <div className="membersPage__grid2Inner">
                      <div className="membersPage__field">
                        ...
                        <input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} required className="membersPage__input" placeholder="+92 300 0000000" />
                      </div>
                      <div className="membersPage__field">
                        <label className="membersPage__label">Email Address *</label>
                        <input type="email" name="email" value={formData.email} onChange={handleInputChange} required className="membersPage__input" placeholder="your.email@example.com" />
                      </div>
                    </div>

                    <div className="membersPage__field">
                      <label className="membersPage__label">Monthly Contribution *</label>
                      <select name="monthly_contribution" value={formData.monthly_contribution} onChange={handleInputChange} required className="membersPage__input">
                    ...
                    <div className="membersPage__uploads">
                      <div className="membersPage__field">
                        ...
                        <div className="membersPage__file">
                          <input type="file" name="profile_image" onChange={handleFileChange} accept="image/*" required className="membersPage__input" />
                      ...
                      <div className="membersPage__field">
                        ...
                        <div className="membersPage__file">
                          <input type="file" name="cnic_image" onChange={handleFileChange} accept="image/*" required className="membersPage__input" />
                          <Upload className="membersPage__fileIcon" />
                        </div>
                      </div>
                      <div className="membersPage__field">
                        ...
                        <div className="membersPage__file">
                          <input type="file" name="contribution_slip" onChange={handleFileChange} accept="image/*" required className="membersPage__input" />
                          <Upload className="membersPage__fileIcon" />
                        </div>
                      </div>
                    </div>
                ...
                <div className="membersPage__side">
                  <div className="membersPage__sideCard membersPage__sideCard--green">
                    ...
                    <ul className="membersPage__benefits">
                      <li><Star className="membersPage__benefitIcon" /> Free funeral services for your family</li>
                      <li><Users className="membersPage__benefitIcon" /> Community support during difficult times</li>
                      <li><Calendar className="membersPage__benefitIcon" /> 24/7 emergency assistance available</li>
                      <li><Award className="membersPage__benefitIcon" /> Participate in noble cause for community</li>
                    </ul>
                  </div>
                    ...
                    <div className="membersPage__contactList">
                      <div className="membersPage__contactItem">
                        ...
                        <div>
                          ...
                          <a className="membersPage__contactValue membersPage__phone" href="tel:+923000797941">
                            +92 300 0797941
                          </a>
                        </div>
                      </div>
                      <div className="membersPage__contactItem">
                        ...
                        <div>
                          ...
                          <a className="membersPage__contactValue membersPage__email" href="mailto:qureshicompassionatealliance@gmail.com">
                      ...
                      <div className="membersPage__contactItem">
                        ...
                        <div>
                          ...
                          <div className="membersPage__contactValue">District Courts, Sargodha</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {activeTab === 'members' && (
              <div className="membersPage__members">
                <div className="membersPage__membersHeader">
                  <h2 className="membersPage__membersTitle">Our Founding Members</h2>
                  <p className="membersPage__membersSubtitle">
